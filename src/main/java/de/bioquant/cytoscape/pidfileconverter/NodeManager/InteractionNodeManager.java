...
public interface InteractionNodeManager {
	...
	/**
	 * Adds the specified interaction to manager's control. if it is not already
	 * present. More formally, adds the specified element newInteraction to this
	...
	/**
	 * Returns true if this manager contains the specified interaction. More
