...
/**
 * Interface for each graph object which has a unique pid (from the pid-xml
 * files).
 * 
...
public interface PidNode {
	...
	/**
	 * Returns the full pid. For interactions "pid_i_", for pathways "pid_p_",
	 * for molecules "pid_m_" is added at the beginning of the ID
	 * 
	 * @return
	 */
	 ...
	 * @throws InvalidIdException thrown if pid is invalid
	 */
